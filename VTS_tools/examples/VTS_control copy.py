...
global blick
# 0 normal 1 sleep 2 awake 3 Shy
global status
global trigger
...
def Normal_Mode(param_list, T_body, blick_num, t):
    ...
    #control param
    #body
    data, param_list[0][3] = Body_NormalMode("FaceAngleX", data, T_body, FaceAngleX1, FaceAngleX0, t)
    data, param_list[1][3] = Body_NormalMode("FaceAngleY", data, T_body, FaceAngleY1, FaceAngleY0, t)
    data, param_list[2][3] = Body_NormalMode("FaceAngleZ", data, T_body, FaceAngleZ1, FaceAngleZ0, t)
    #Eye ball
    ...
    #Eye Open
    data, param_list[5][3] = EyeOpen_NormalMode(data, T = T_eye, y0 = EyeOpen0, y1 = EyeOpen1, t = t, N = blick_num)
...
def Awake_Mode(param_list, T_body, blick_num, t):
    ...
    #control param
    #body
    data, param_list[0][3] = Body_AwakeMode("FaceAngleX", data, T_body, FaceAngleX1, FaceAngleX0, t)
    data, param_list[1][3] = Body_AwakeMode("FaceAngleY", data, T_body, FaceAngleY1, FaceAngleY0, t)
    data, param_list[2][3] = Body_AwakeMode("FaceAngleZ", data, T_body, FaceAngleZ1, FaceAngleZ0, t)
    #Eye ball
    data, param_list[3][3] = EyeBallMotion("EyeRightX", data, T_body, EyeX1, EyeX0, t)
    data, param_list[4][3] = EyeBallMotion("EyeRightY", data, T_body, EyeY1, EyeY0, t)     
    #Eye Open
    data, param_list[5][3] = EyeOpen_Blick(data, t0 = 0, T = 0.3, y0 = 0, y1 = 1, t = 0, N = 3)
    return param_list, data
...
def Shy_Mode(param_list, T_body, blick_num, t):
    ...
    #control param
    #body
    data, param_list[0][3] = Body_ShyMode("FaceAngleX", data, T_body, FaceAngleX1, FaceAngleX0, t)
    data, param_list[1][3] = Body_ShyMode("FaceAngleY", data, T_body, FaceAngleY1, FaceAngleY0, t)
    data, param_list[2][3] = Body_ShyMode("FaceAngleZ", data, T_body, FaceAngleZ1, FaceAngleZ0, t)
    #Eye ball
    data, param_list[3][3] = EyeBallMotion_ShyMode("EyeRightX", data, T_body, EyeX1, EyeX0, t)
    data, param_list[4][3] = EyeBallMotion_ShyMode("EyeRightY", data, T_body, EyeY1, EyeY0, t)     
    #Eye Open
    data, param_list[5][3] = EyeOpen_ShyMode(data, t0 = 0, T = 0.3, y0 = 0, y1 = 1, t = 0, N = 3)
    return param_list, data
